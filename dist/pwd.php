  ...
  <body>
    ...
    <main class="row m-0 ">
      <div class="col-sm-6 logon ">
        <form class="w-100 mx-448 m-auto" method="POST">
          <div class="text-center mb-5">
            <h1 class="fw-bold fs-32px">Bienvenido de nuevo!</h1>
          </div>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Por favor ingrese su contraseña:</label>
            <input type="password" required name="pwd" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
          </div>
          <button class="btn btn-primary mb-4 rounded-3 w-100 fw-bold text-uppercase" name="log">comenzar</button>
          <p>
            <a href="" class="text-dark">¿Olvidaste tu contraseña o queres crearla por primera vez?</a>
          </p>
        </form>
      </div>
      <div class="col-sm-6 d-none d-sm-block">
        <div class="content-img">
          <figure class="figure-content">
            <img src="images/auth-21cc4c243bd67465c600df2de40dafc4b99816a627ffd88515e0a5f64fdf0252.svg" class="w-100 img-responsive">
          </figure>
        </div>
      </div>
    </main>
